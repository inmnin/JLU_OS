...
public class Peterson_Thread implements Runnable{
    private int id;
    private Peterson_Page page;

    Peterson_Thread(int id,Peterson_Page page){
        this.id = id;
        this.page = page;
    }
    @Override
    public void run() {
        ...
        page.left_mid_block.add(page.mypanel0);

        page.mypanel1.setcolor(1);
        page.left_mid_block.add(page.mypanel1);
